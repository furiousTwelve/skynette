...
public class PanelDetails extends JPanel implements ActionListener,MouseListener{
	...
	protected JLabel empty = new JLabel("go");
	protected JLabel empty2 = new JLabel("go");

	protected JLabel temperatureIcone1 = new JLabel();
	ImageIcon icontemp1 = new ImageIcon(new ImageIcon("..\\..\\git\\skynette\\icon_weather\\rain-1.png").getImage()
			.getScaledInstance(90, 90, Image.SCALE_DEFAULT));
	protected JLabel temperatureIcone2 = new JLabel();
	ImageIcon icontemp2 = new ImageIcon(new ImageIcon("..\\..\\git\\skynette\\icon_weather\\rain-1.png").getImage()
			.getScaledInstance(90, 90, Image.SCALE_DEFAULT));
